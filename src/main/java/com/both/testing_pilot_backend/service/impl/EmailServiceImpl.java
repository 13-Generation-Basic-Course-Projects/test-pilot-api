...
public class EmailServiceImpl implements EmailService {
    ...
    @Override
    public void sendAcceptLinkVerification(InviteCollaboratorEvent payload) {
        String sendTo = payload.getEmail();
        String subject = "You're Invited to Collaborate!";
        String templateName = "invite-collaborator";

        Map<String, Object> variables = new HashMap<>();
        variables.put("logoUrl", "https://lh3.googleusercontent.com/a/ACg8ocI6Xb97ga-IEBsn-AcJrrhJmXlzXki5xBOyzLD38kMQTU3Uo1E=s288-c-no");
        variables.put("companyName", "TestingPilot");
        variables.put("projectCollaboratorId",payload.getProjectCollaboratorId());
        variables.put("acceptLink", payload.getAcceptLink());
        variables.put("supportEmail", supportEmail);
        variables.put("year", 2025);
        variables.put("companyAddress", "KHSRD Center");
    ...
    public void sendHtmlEmail(String sendTo, String subject, String htmlBody) {
